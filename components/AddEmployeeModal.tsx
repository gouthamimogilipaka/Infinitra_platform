...
export const AddEmployeeModal: React.FC<AddEmployeeModalProps> = ({ isOpen, onClose }) => {
    ...
    const [department, setDepartment] = useState('Contributor');
            ...
            <div className="bg-gray-800 rounded-xl shadow-2xl p-8 w-full max-w-lg border border-gray-700 relative" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                     ...
                     <div>
                        <label htmlFor="department" className="block text-sm font-medium text-gray-300 mb-1">Role/Team (e.g. Contributor)</label>
                        {/* FIX: Changed focus ring color to violet for consistency. */}
